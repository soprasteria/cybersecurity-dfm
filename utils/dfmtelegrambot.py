                    ...
                    if command==None or command=="teach":
                        ...
                        if results != None:
                            if "text" in results["_source"]:
                                ...
                                built_message+="Share on: [Twitter](https://twitter.com/intent/tweet?text="+results["_source"]["title"].strip()+" #"+topics_message[:-5]+" "+tags_message_list[0]+" "+tags_message_list[1]+" "+tags_message_list[2]+" "+results["_source"]["link"]+")"
                                built_message+=", [Linkedin](https://www.linkedin.com/shareArticle?mini=true&url="+results["_source"]["link"]+"&summary="+extract+"\n#"+topics_message[:-5]+" "+tags_message_list[0]+" "+tags_message_list[1]+" "+tags_message_list[2]+")"

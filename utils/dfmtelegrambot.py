                    ...
                    if command==None or command=="teach":
                        ...
                        if results != None:
                            if "text" in results["_source"]:
                                ...
                                built_message+="Share on: [Twitter](https://twitter.com/intent/tweet?text="+urlparse(results["_source"]["title"])+"\n#"+topics_message[:-5]+" "+tags_message_list[0]+" "+tags_message_list[1]+" "+tags_message_list[2]+"\n"+urlparse(results["_source"]["link"])+")"
                                built_message+=", [Linkedin](https://www.linkedin.com/shareArticle?mini=true&url="+urlparse(results["_source"]["link"])+"&summary="+urlparse(extract)+"\n#"+topics_message[:-5]+" "+tags_message_list[0]+" "+tags_message_list[1]+" "+tags_message_list[2]+")"
                                built_message+=", [Reddit](https://www.reddit.com/submit?url="+urlparse(results["_source"]["link"])+")"

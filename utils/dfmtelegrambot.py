                    ...
                    if command==None or command=="teach":
                        ...
                        if results != None:
                            if "text" in results["_source"]:
                                ...
                                extract=" ".join(results["_source"]["text"][0:250].strip().replace('[','').replace(']','').replace('$','').splitlines())

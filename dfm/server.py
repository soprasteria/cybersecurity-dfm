...
class DataGraph(Resource):
    ...
    def get(self):
        ...
        edges={}
        result={"nodes": [],"edges": []}
        query={ "stored_fields": [ "_id", "updated", "_parent", "title", "text", "format", "summary", "source", "author", "source_type", "link", "topics", "tags" ],"size": size, "query": { "bool": { "must": [ { "exists": { "field": "text" } }, { "type": { "value": "doc" } }, { "range": { "updated": { "gte": gte, "lt": lt } } } ] } }, "aggs": { "graph": { "nested": { "path": "topics" }, "aggs": { "topics": { "terms": { "field": "topics.label", "size":int(size/5) }, "aggs": { "linked_tags": { "reverse_nested": {}, "aggs": { "tags": { "terms": { "field": "tags", "size":int(size/2) }, "aggs": { "linked_links": { "reverse_nested": {}, "aggs": { "links": { "terms": { "field": "link", "size":int(size/1.5) }, "aggs": { "fields": { "top_hits": { "size": 1, "_source": { "include": [ "title", "source", "summary", "source_type", "author", "text", "topics" ] } } } } } } } } } } } } } } } } }
        if q is not None:
